...
@Component({
  selector: 'app-edp-cc-remuestrafisicapendientes',
  templateUrl: './edp-cc-remuestrafisicapendientes.page.html',
  styleUrls: ['./edp-cc-remuestrafisicapendientes.page.scss'],
})
export class EdpCcRemuestrafisicapendientesPage implements OnInit {
...
muestras(cabecera:any){
  this.storage.set('cabecera_fisica', cabecera);
  this.router.navigate(['/edp-cc-remuestrasfisicas']); 
}
