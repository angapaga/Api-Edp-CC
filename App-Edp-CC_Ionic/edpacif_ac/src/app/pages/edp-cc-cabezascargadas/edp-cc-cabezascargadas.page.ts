...
@Component({
  selector: 'app-edp-cc-cabezascargadas',
  templateUrl: './edp-cc-cabezascargadas.page.html',
  styleUrls: ['./edp-cc-cabezascargadas.page.scss'],
})
export class EdpCcCabezascargadasPage implements OnInit {
  ...
  ngOnInit() { 
    ...
    this.storage.get('session_storage').then((res) => {
      ...
      this.storage.get('periodo').then((res) => {
        this.periodo = res; 
          this.storage.get('cabecera_cabezas').then((res) => {
            this.cabecera = res; 
...
mostrar_pe(cabecera:any) {
  return new Promise((resolve, reject) => {
    ...
    let body = {
      peticion: "cabecera_remuestra_cabezas_cabecera",
...
mostrar_detalles_pr(cabecera:any) {
  return new Promise((resolve, reject) => {
    ...
    let body = {
      peticion: "detalles_remuestra_cabezas_cabecera",
      cod_usua: this.cod_usua,
      cabecera: cabecera,
      periodo: this.periodo,
    };
